                    ...
                    <div class="sidebar-content">
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item">
                                    <a title="Gerenciar Sistema" data-toggle="tooltip" data-placement="bottom" href="<?= base_url('')?>sistema"><i class="ik ik-settings"></i><span>Sistema</span></a>
                                </div>
                                <div class="nav-item">
                                    <a title="Gerenciar Usuários" data-toggle="tooltip" data-placement="bottom" href="<?= base_url('')?>usuarios"><i class="ik ik-users"></i><span>Usuários</span></a>
                                </div>
                                <div class="nav-item">
                                    <a title="Gerenciar Precificações" data-toggle="tooltip" data-placement="bottom" href="<?= base_url('')?>precificacoes"><i class="ik ik-dollar-sign"></i><span>Precificações</span></a>
                                </div>
                                ...
                                <!-- <div class="nav-item">
                                    <a href="javascript:void(0)"><i class="ik ik-monitor"></i><span>Teste</span></a>
                                </div> -->
                                <div class="nav-item">
                                    <a href="javascript:void(0)"><i class="ik ik-phone"></i><span>Contacts</span></a>
                                </div>
                            </nav>
                        </div>
                    </div>
